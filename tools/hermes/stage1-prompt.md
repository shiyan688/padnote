...
/public/home/wangyg/padnote/tools/hermes/.runtime/tasks/percentages
...
简要规划一次就写 IR；不要反复讨论同一个方案。只在校验出现具体失败后才读实现代码。执行 npm 命令时显式在 PATH 前加 /public/home/wangyg/padnote/agent-skills/padnote-video-explainer/.local-cache/node/node-v22.22.0-linux-x64/bin；已安装全部视频依赖，不需检查系统 Node 或重复探索目录。
